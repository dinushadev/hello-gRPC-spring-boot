package pl.piomin.services.grpc.grpctestservice2;
...
public class GrpcTestService2Application {

	public static void main(String[] args) {
		SpringApplication.run(GrpcTestService2Application.class, args);
	}

	@Bean
	AccountRepository repository() {
		List<AccountProto.Account> accounts = new ArrayList<>();
		accounts.add(AccountProto.Account.newBuilder().setId(1).setCustomerId(1).setNumber("888888").build());
